classdef Visualizer2D < matlab.System & matlab.system.mixin.CustomIcon
    ...
    methods(Access = protected)
        ...
        function setupImpl(obj)
            ...
            if obj.robotRadius > 0
                % Finite size robot
                obj.RobotHandle = plot(obj.ax,0,0,'m','LineWidth',2);
            else
                % Point robot
                obj.RobotHandle = plot(obj.ax,0,0,'mo', ...
            ...
            if obj.hasLidar
                ...
                for idx = 1:numel(ranges)
                    if ~isnan(ranges(idx))
                        ...
                        alpha = theta + obj.sensorAngleOffset + obj.scanAngles(idx);                      
    ...
    methods (Access = public)        
        ...
        function attachLidarSensor(obj,lidar)
            ...
            obj.sensorAngleOffset = lidar.sensorAngleOffset;
